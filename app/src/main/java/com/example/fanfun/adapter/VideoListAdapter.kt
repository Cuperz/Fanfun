...
class VideoListAdapter(private val mActivity: VideoListActivity, var mVideoList: ArrayList<Model.ListVideo>): RecyclerView.Adapter<VideoListAdapter.ViewHolder>() {
